...
export function Godparents({ theme, data }: GodparentsProps) {
  ...
  return (
    <section className="py-16 px-6 max-w-5xl mx-auto text-center" id="invitation-godparents">
      <motion.div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {people.map((person, idx) => (
            <motion.div
              ...
              className="p-6 rounded-3xl border shadow-sm flex flex-col items-center space-y-4 text-center"
              style={{
